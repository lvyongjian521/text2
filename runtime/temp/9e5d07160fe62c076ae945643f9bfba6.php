<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"C:\wwwroot\lvyongjian.xyz/application/admin\view\comment\index.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\head.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\foot.html";i:1579008637;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form " method="post">
                ...
                <div class="layui-input-inline w100">
                    <select name="mid">
                        ...
                        <option value="8" <?php if($param['mid'] == '8'): ?>selected <?php endif; ?>>演员</option>
                        <option value="9" <?php if($param['mid'] == '9'): ?>selected <?php endif; ?>>角色</option>
                        <option value="11" <?php if($param['mid'] == '11'): ?>selected <?php endif; ?>>网址</option>
                    </select>
                </div>
                <div class="layui-input-inline w100">
                    <select name="report">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="f-12 c-999">
                        评论：<?php echo htmlspecialchars($vo['comment_content']); ?>
                    </div>
                </td>
                <td>
