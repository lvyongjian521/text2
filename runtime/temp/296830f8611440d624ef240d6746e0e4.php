...
<div class="layout clearfix">
	<div class="reg-w">
		<form method="post" id="fm" action="">
			...
			<?php endif; ?>
			<input type="button" id="btn_submit" class="btn-brand btn-sub" value="立即注册" style="background: rgb(0, 176, 236);">
		</form>
	</div>
