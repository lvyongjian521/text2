<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"template/b/html/comment\ajax.html";i:1544420974;}*/ ?>
    <!--评论开始-->
    <form class="comment_form cmt_form clearfix"  >
        <input type="hidden" name="comment_pid" value="0">
        <!--评论框-->
        <div class="input_wrap fl clearfix">
            <textarea class="comment_content fl" name="comment_content" placeholder="小伙子，请说一下你的看法！"></textarea>
            <div class="fl clearfix handle">
                <div class="comment_face_panel face">
                    <i class="icon-face"></i>
                </div>
                <div class="comment_face_box face-box">
                    <?php $__FOR_START_2119155732__=1;$__FOR_END_2119155732__=16;for($i=$__FOR_START_2119155732__;$i <= $__FOR_END_2119155732__;$i+=1){ ?>
            ...
            <div class="cmt_item clearfix">
                ...
                <div class="item_con fl">
                    <p class="top">
                        ...
                        (<a >(<?php echo long2ip($vo['comment_ip']); ?>)</a>)
                    </p>
                    ...
                    <div class="cmt_item clearfix">
                        ...
                        <div class="item_con fl">
                            <p class="top">
                                ...
                                (<a >(<?php echo long2ip($child['comment_ip']); ?>)</a>)
                            </p>
