<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"C:\wwwroot\lvyongjian.xyz/application/admin\view\website\index.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\head.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\foot.html";i:1579008637;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <div class="my-toolbar-box">
            ...
            <form class="layui-form " method="post">
                ...
                <div class="layui-input-inline w150">
                    <select name="order">
                        ...
                        <option value="website_time" <?php if($param['order'] == 'website_time'): ?>selected<?php endif; ?>>更新时间</option>
                        <option value="website_id" <?php if($param['order'] == 'website_id'): ?>selected<?php endif; ?>>编号</option>
                        <option value="website_hits" <?php if($param['order'] == 'website_hits'): ?>selected<?php endif; ?>>总人气</option>
                        <option value="website_hits_month" <?php if($param['order'] == 'website_hits_month'): ?>selected<?php endif; ?>>月人气</option>
                        <option value="website_hits_week" <?php if($param['order'] == 'website_hits_week'): ?>selected<?php endif; ?>>周人气</option>
                        <option value="website_hits_day" <?php if($param['order'] == 'website_hits_day'): ?>selected<?php endif; ?>>日人气</option>
                    </select>
                </div>
        ...
        <div class="layui-btn-group">
            ...
            <a data-href="<?php echo url('index/select'); ?>?tab=website&col=type_id&tpl=select_type&url=website/field" data-width="270" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i>分类</a>
            <a data-href="<?php echo url('index/select'); ?>?tab=website&col=website_level&tpl=select_level&url=website/field" data-width="270" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i>推荐</a>
            <a data-href="<?php echo url('index/select'); ?>?tab=website&col=website_hits&tpl=select_hits&url=website/field" data-width="470" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i>点击</a>
            <a data-href="<?php echo url('index/select'); ?>?tab=website&col=website_status&tpl=select_status&url=website/field" data-width="470" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i>状态</a>
            <a data-href="<?php echo url('index/select'); ?>?tab=website&col=website_lock&tpl=select_lock&url=website/field" data-width="470" data-height="100" data-checkbox="1" class="layui-btn layui-btn-primary j-select"><i class="layui-icon">&#xe620;</i>锁定</a>
            <a class="layui-btn layui-btn-primary j-iframe" data-href="<?php echo url('images/opt?tab=website'); ?>" href="javascript:;" title="同步远程图片"><i class="layui-icon">&#xe620;</i>同步图片</a>
            <a class="layui-btn layui-btn-primary j-iframe" data-checkbox="true" data-href="<?php echo url('make/make?ac=info&tab=website'); ?>" href="javascript:;" title="生成页面"><i class="layui-icon">&#xe620;</i>生成页面</a>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>[<?php echo $vo['type']['type_name']; ?>] <a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_website_detail($vo); ?>"><?php echo htmlspecialchars($vo['website_name']); ?></a> <?php if($vo['website_status'] == 0): ?> <span class="layui-badge">未审</span><?php endif; if($vo['website_lock'] == 1): ?> <span class="layui-badge">锁定</span><?php endif; ?></td>
                ...
                <td>
                    <a class="layui-badge-rim j-ajax" data-href="<?php echo url('index/check_back_link'); ?>?url=<?php echo $vo['website_jumpurl']; ?>" refresh="no" href="javascript:;" title="检测">检测</a>
                    <a class="layui-badge-rim j-iframe" data-full="1" data-href="<?php echo url('info?id='.$vo['website_id']); ?>" href="javascript:;" title="编辑">编辑</a>
                    <a class="layui-badge-rim j-tr-del" data-href="<?php echo url('del?ids='.$vo['website_id']); ?>" href="javascript:;" title="删除">删除</a>
                </td>
            </tr>
