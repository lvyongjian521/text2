<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"C:\wwwroot\lvyongjian.xyz/application/admin\view\topic\index.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\head.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\foot.html";i:1579008637;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form" method="post" id="pageListForm" >
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td><a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_topic_detail($vo); ?>"><?php echo htmlspecialchars($vo['topic_name']); ?></a> <?php if($vo['topic_status'] == 0): ?> <span class="layui-badge">未审</span><?php endif; ?> </td>
