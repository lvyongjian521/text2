<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"C:\wwwroot\lvyongjian.xyz/application/admin\view\system\configcollect.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\head.html";i:1579008637;s:65:"C:\wwwroot\lvyongjian.xyz\application\admin\view\public\foot.html";i:1579008637;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" action="">
        <div class="layui-tab" lay-filter="tb1">
            <ul class="layui-tab-title">
                ...
                <li lay-id="configcollect_3">演员采集设置</li>
                <li lay-id="configcollect_4">角色采集设置</li>
                <li lay-id="configcollect_5">网址采集设置</li>
                <li lay-id="configcollect_6">采集词库设置</li>
            </ul>
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="checkbox" lay-skin="primary" name="collect[actor][inrule][]" value="c" title="分类" <?php if(strpos($config['collect']['actor']['inrule'],'c') !==false): ?>checked <?php endif; ?>>
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">数据状态：</label>
                        <div class="layui-input-block">
                            <input type="radio" name="collect[website][status]" value="0" title="未审" <?php if($config['collect']['website']['status'] != 1): ?>checked <?php endif; ?>>
                            <input type="radio" name="collect[website][status]" value="1" title="已审" <?php if($config['collect']['website']['status'] == 1): ?>checked <?php endif; ?>>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">随机点击量：</label>
                        <div class="layui-input-inline">
                            <input type="text" name="collect[website][hits_start]" placeholder="最小值" value="<?php echo $config['collect']['website']['hits_start']; ?>" class="layui-input">
                        </div>
                        <div class="layui-input-inline">
                            <input type="text" name="collect[website][hits_end]" placeholder="最大值" value="<?php echo $config['collect']['website']['hits_end']; ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">随机顶踩：</label>
                        <div class="layui-input-inline">
                            <input type="text" name="collect[website][updown_start]" placeholder="最小值" value="<?php echo $config['collect']['website']['updown_start']; ?>" class="layui-input">
                        </div>
                        <div class="layui-input-inline">
                            <input type="text" name="collect[website][updown_end]" placeholder="最大值" value="<?php echo $config['collect']['website']['updown_end']; ?>" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">随机评分数：</label>
                        <div class="layui-input-block">
                            <input type="radio" name="collect[website][score]" value="0" title="关闭" <?php if($config['collect']['website']['score'] != 1): ?>checked <?php endif; ?>>
                            <input type="radio" name="collect[website][score]" value="1" title="开启" <?php if($config['collect']['website']['score'] == 1): ?>checked <?php endif; ?>>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">自动同步图片：</label>
                        <div class="layui-input-block">
                            <input type="radio" name="collect[website][pic]" value="0" title="关闭" <?php if($config['collect']['website']['pic'] != 1): ?>checked <?php endif; ?>>
                            <input type="radio" name="collect[website][pic]" value="1" title="开启" <?php if($config['collect']['website']['pic'] == 1): ?>checked <?php endif; ?>>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">介绍随机插入语句：</label>
                        <div class="layui-input-block">
                            <input type="radio" name="collect[website][psernd]" value="0" title="关闭" <?php if($config['collect']['website']['psernd'] != 1): ?>checked <?php endif; ?>>
                            <input type="radio" name="collect[website][psernd]" value="1" title="开启" <?php if($config['collect']['website']['psernd'] == 1): ?>checked <?php endif; ?>>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">介绍同义词替换：</label>
                        <div class="layui-input-block">
                            <input type="radio" name="collect[website][psesyn]" value="0" title="关闭" <?php if($config['collect']['website']['psesyn'] != 1): ?>checked <?php endif; ?>>
                            <input type="radio" name="collect[website][psesyn]" value="1" title="开启" <?php if($config['collect']['website']['psesyn'] == 1): ?>checked <?php endif; ?>>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">入库重复规则：</label>
                        <div class="layui-input-block">
                            <input type="checkbox" lay-skin="primary" name="collect[website][inrule][]" value="a" title="标题" checked disabled>
                            <input type="checkbox" lay-skin="primary" name="collect[website][inrule][]" value="b" title="分类" <?php if(strpos($config['collect']['website']['inrule'],'b') !==false): ?>checked <?php endif; ?>>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">二次更新规则：</label>
                        <div class="layui-input-block">
                            <input type="checkbox" lay-skin="primary" name="collect[website][uprule][]" value="a" title="详情" <?php if(strpos($config['collect']['website']['uprule'],'a') !==false): ?>checked <?php endif; ?>>
                            <input type="checkbox" lay-skin="primary" name="collect[website][uprule][]" value="b" title="简介" <?php if(strpos($config['collect']['website']['uprule'],'b') !==false): ?>checked <?php endif; ?>>
                            <input type="checkbox" lay-skin="primary" name="collect[website][uprule][]" value="c" title="备注" <?php if(strpos($config['collect']['website']['uprule'],'c') !==false): ?>checked <?php endif; ?>>
                            <input type="checkbox" lay-skin="primary" name="collect[website][uprule][]" value="d" title="跳转地址" <?php if(strpos($config['collect']['website']['uprule'],'d') !==false): ?>checked <?php endif; ?>>
                            <input type="checkbox" lay-skin="primary" name="collect[website][uprule][]" value="e" title="图片" <?php if(strpos($config['collect']['website']['uprule'],'e') !==false): ?>checked <?php endif; ?>>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">数据过滤：</label>
                        <div class="layui-input-block">
                            <textarea name="collect[website][filter]" class="layui-textarea" placeholder="多个数据请用逗号分隔"><?php echo $config['collect']['website']['filter']; ?></textarea>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">演员介绍同义词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">演员介绍随机词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">网址介绍同义词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">网址介绍随机词库：</label>
                    <div class="layui-input-block">
