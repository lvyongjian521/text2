<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"template/b_new/html/vod\search.html";i:1577616180;s:65:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\public\include.html";i:1577612338;s:64:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\public\paging.html";i:1577683482;s:62:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\public\foot.html";i:1577612560;}*/ ?>
<html>
...
<head>
    ...
    <meta name="keywords" content="$param.wd}<?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?>-<?php echo $maccms['site_name']; ?>" />

    <meta name="description" content="<?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?>-<?php echo $maccms['site_name']; ?>,<?php echo $maccms['site_name']; ?>" />
...
<body>
		...
		<div class="top">
		    ...
		    <div class="search-box">
				...
				<form class="search-form" method="post" target="_self" action="<?php echo mac_url('vod/search'); ?>">

  		      <input class="1mac_wd" type="search" name="wd" maxlength="33" autocomplete="off" placeholder="<?php echo mac_default($maccms['search_placeholder'],'输入搜索关键字'); ?>"value="">
		...
		<div class="hot-search" style="display: none;">
				...
				<?php $_6027b7874003c=explode(',',$maccms['search_hot']); if(is_array($_6027b7874003c) || $_6027b7874003c instanceof \think\Collection || $_6027b7874003c instanceof \think\Paginator): if( count($_6027b7874003c)==0 ) : echo "" ;else: foreach($_6027b7874003c as $key2=>$vo2): ?>

   		    	<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="word"><p><?php echo $vo2; ?></p></a>
			...
			<section class="main">
  			  ...
  			  <div class="main-head">
					...
					<div class="title"><p>搜索到与"<b><?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?></b>"相关的<b class="total"></b>条结果</p></div>
 			   ...
 			   <div class="main-body">
				  ...
				  <div class="search_tips" style="display: none;"><p>很抱歉，暂无相关视频！如需提醒管理员添加该视频请点击&nbsp;&nbsp;<a href="javascript:void(0)" onClick="MAC.Gbook.Report('请管理员添加《<?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?>》，谢谢！')">&nbsp;留言</a>&nbsp;，谢谢！</p><p>提示（如果搜索词错误也将无法搜到，可尝试简化搜索词）</p></div>
...
<div class="notdata"><img src="<?php echo $maccms['path_tpl']; ?>img/noTFound.png"><p>什么都没有找到啊 T_T</p></div><?php endif; ?>
			...
			var total ="<?php echo $__PAGING__['record_total']; ?>";if( total < 1){$(".search_tips").show();}else{$(".hot-search").show();}

			$('.total').html('<?php echo $__PAGING__['record_total']; ?>');</script>
