<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:35:"template/b_new/html/label\week.html";i:1577609250;s:65:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\public\include.html";i:1577612338;s:61:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\jdyzm\head.html";i:1575023310;s:67:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\jdyzm\head-title.html";i:1575023436;s:65:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\jdyzm\head-nav.html";i:1577442556;s:63:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\jdyzm\banner.html";i:1577429890;s:62:"C:\wwwroot\lvyongjian.xyz\template\b_new\html\public\foot.html";i:1577612560;}*/ ?>
<html>
<head>
    <meta charset="utf-8">
    <title>周播表 - 最新更新 - <?php echo $maccms['site_name']; ?></title>
...
<div class="head-top"></div>
	...
	<div class="weeks">
				...
				<li id="week1">周一</li><li id="week2">周二</li><li id="week3">周三</li><li id="week4">周四</li><li id="week5">周五</li><li id="week6">周六</li><li id="week0">周日</li>			</ul>
			<div class="weekbox">
				<div class="box01_c" id="weekcon">
					<div style="position:relative;">
						<dl><dt class="week-day-1">周一</dt>
						...
						<div class="item-week"><a class="item-link" href="<?php echo mac_url_vod_play($vo); ?>"><div class="item-imgContainer lazy-thumb" data-original="<?php echo $vo['vod_pic']; ?>"></div><div class="title"><p><?php echo $vo['vod_name']; ?></p><e><?php if($vo['vod_serial'] > 0): ?>更新至 <t <?php if(date( 'd',$vo['vod_time']) == date( 'd',time())): ?>style="color: #ff8eb3;font-weight: bold;"<?php endif; ?>><?php echo $vo['vod_serial']; ?>话</t><?php else: ?><?php echo $vo['vod_remarks']; endif; ?></e></div></a></div>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</dl>
						<dl><dt class="week-day-2">周二</dt>
