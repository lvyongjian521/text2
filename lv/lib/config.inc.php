...
/** 数据库设置 */
define('SQLDEBUG',1);
define('DB','lvyongjian_xyz');//MYSQL数据库名
define('DH','127.0.0.1');//MYSQL主机名，不用改
define('DU','lvyongjian_xyz');//MYSQL数据库用户名
define('DP','lyj312325824');//MYSQL数据库用户密码
...
define('WXAPPID','wxa169290451544e08');
define('WXAPPSECRET','a3d931c59f52280bb0e7e38a251088bb');
