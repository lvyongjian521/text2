...
<?php } ?>
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-seminar&page=<?php echo $this->tpl_var['page']; ?>">专题管理</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					<h4 class="title" style="padding:10px;">
						添加专题
						<a class="btn btn-primary pull-right" href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-seminars&catid=<?php echo $this->tpl_var['catid']; ?>&page=<?php echo $this->tpl_var['page']; ?>">专题管理</a>
					</h4>
					<form action="index.php?seminar-master-seminar-add" method="post" class="form-horizontal">
				        ...
				        <div class="form-group">
				            ...
				            <div class="col-sm-4">
							    <input class="form-control datetimepicker" data-minview="0" data-date="<?php echo date('Y-m-d H:i:s',TIME); ?>" data-date-format="yyyy-mm-dd hh:ii:ss" type="text" id="seminartitle" name="args[seminarinputtime]" needle="needle" msg="您必须输入发布时间">
					        </div>
				        </div>
				        <div class="form-group">
 ...
 $tid++; ?>
									<option value="<?php echo $tpl['stplid']; ?>"><?php echo $tpl['stplname']; ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
