...
<?php } ?>
 ...
 $fid++; ?>
								...
								<td>
									<div class="btn-group">
										<a class="btn" href="index.php?exam-master-basic-readpaper&page=<?php echo $this->tpl_var['page']; ?>&ehid=<?php echo $exam['ehid']; ?><?php echo $this->tpl_var['u']; ?>" title="阅卷"><em class="glyphicon glyphicon-save-file"></em></a>
										<a class="btn confirm" href="index.php?exam-master-basic-delhistory&ehid=<?php echo $exam['ehid']; ?>" title="删除"><em class="glyphicon glyphicon-remove"></em></a>
									</div>
								</td>
					        </tr>
					        <?php } ?>
