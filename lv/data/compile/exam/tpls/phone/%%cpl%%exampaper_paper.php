 ...
 $qnid++; ?>
						...
						<div class="swiper-slide" style="overflow-y: scroll">
							<ol>
                                ...
                                <?php if(!$this->tpl_var['questype'][$quest]['questsort'] && $this->tpl_var['questype'][$quest]['questchoice'] != 5){ ?>
								<li class="unstyled">
									<div class="rows">
 ...
 $qid++; ?>
						...
						<div class="swiper-slide" style="overflow-y: scroll">
							<ol>
                                ...
                                <?php if(!$this->tpl_var['questype'][$question['questiontype']]['questsort'] && $this->tpl_var['questype'][$question['questiontype']]['questchoice'] != 5){ ?>
								<li class="unstyled">
									<div class="rows">
										<p><?php echo html_entity_decode($this->ev->stripSlashes($question['questionselect'])); ?></p>
									</div>
 ...
 $did++; ?>
	...
	<script>
        function outexam(){
            ...
            history.pushState({id:'index.php?exam-phone-exampaper-paper'},'<?php echo $this->tpl_var['sessionvars']['examsession']; ?>','index.php?exam-phone-exampaper-paper');
		}
		$(function(){
