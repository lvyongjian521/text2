...
<?php } ?>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						课件管理
						<a class="btn btn-primary pull-right" href="index.php?course-master-contents-addpage&courseid=<?php echo $this->tpl_var['course']['csid']; ?>&page=<?php echo $this->tpl_var['page']; ?>">添加课件</a>
					</h4>
