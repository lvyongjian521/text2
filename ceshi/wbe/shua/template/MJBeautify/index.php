...
<!--自助下单区域-->
		...
		<div class="tab-pane fade in active" id="onlinebuy" style="padding:5px 0 10px 0;" ><?php echo $conf['alert']?>
...
<div class="qqkf-card" style="margin-bottom:8px;">
	<div class="left-box"><img src="//q4.qlogo.cn/headimg_dl?dst_uin=26786385&spec=100"></div>
	<div class="right-box tw1">
		...
		<b>QQ</b>：<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq']?>&site=qq&menu=yes" target="_blank" style="color:#0080ff"><?php echo $conf['kfqq']?></a> <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $conf['kfqq']?>&site=qq&menu=yes" target="_blank" class="btn btn-info btn-sm rdu-5x" style="padding:2px 8px;">添加</a>
	</div>
</div>
...
<a href="./user/regsite.php" class="zdxx-lj-li"><font color="#ff00ff">搭建分站仅需50一150元</font>   
