...
function getkuaishouid(){
	...
	if(kuauishouurl.indexOf('gifshow.com')<0 && kuauishouurl.indexOf('kuaishou.com')<0 && kuauishouurl.indexOf('kwai.com')<0 && kuauishouurl.indexOf('kspkg.com')<0 && kuauishouurl.indexOf('yxixy.com')<0){layer.alert('请输入正确的快手作品链接！');return false;}
...
function get_kuaishou(id,ksid){
	...
	if(kuauishouurl.indexOf('gifshow.com')<0 && kuauishouurl.indexOf('kuaishou.com')<0 && kuauishouurl.indexOf('kwai.com')<0 && kuauishouurl.indexOf('etoote.com')<0 && kuauishouurl.indexOf('kspkg.com')<0 && kuauishouurl.indexOf('yxixy.com')<0){layer.alert('请输入正确的快手作品链接！');return false;}
	if(kuauishouurl.indexOf('/s/')>0){
		var ii = layer.load(2, {shade:[0.1,'#fff']});
		$.ajax({
			type : "POST",
