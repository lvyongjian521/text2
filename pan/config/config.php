...
$_config['db']['1']['dbuser'] = 'lvyongjian_xyz';
$_config['db']['1']['dbpw'] = 'lyj312325824';
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'lvyongjian_xyz';
$_config['db']['1']['tablepre'] = 'lvyongjianpan_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'b8eb_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '330d35rqHxDDY7Mv';
