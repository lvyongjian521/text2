<?php if(!defined('IN_DZZ')) exit('Access Denied'); /*a:3:{s:78:"C:\wwwroot\lvyongjian.xyz\pan\/./dzz/explorer/template/mobile/file_content.htm";i:1613354169;s:81:"C:\wwwroot\lvyongjian.xyz\pan\/./dzz/explorer/template/mobile/template_normal.htm";i:1613354169;s:81:"C:\wwwroot\lvyongjian.xyz\pan\/./dzz/explorer/template/mobile/template_footer.htm";i:1613354169;}*/?>
<!DOCTYPE html>
<html>
...
<section class="weui-address">
    ...
    <ul class="weui-address-field">
                <?php if($gid && $group['type']) { ?>
                <li>
                    <a href="<?php echo $_G['siteurl'];?><?php echo MOD_URL;?>&op=mobile&do=group">群组</a><span class="dzz dzz-chevron-right"></span>
                </li>
                <?php } ?>
        <?php if(is_array($folderpatharr)) foreach($folderpatharr as $v) { ?>        <li>
            <a href="<?php echo $_G['siteurl'];?><?php echo MOD_URL;?>&op=mobile&do=file&gid=<?php echo $v['gid'];?>&fid=<?php echo $v['fid'];?>"><?php echo $v['name'];?></a><span class="dzz dzz-chevron-right"></span>
        </li>
        <?php } ?>
    </ul>
    </div>
...
<!--地址栏结束-->
<!--列表开始-->
<section class="weui-cells weui-cells__recent weui-cells__margin_footer" id="fileList-<?php echo $fid;?>">


</section>
<!--列表结束-->
<div class="weui-cell-search-normal" style="display: none;">
    <div class="weui-cell-search-images">
...
<!--<script type="text/javascript" src="<?php echo MOD_PATH;?>/js/mobile/flexible.js" ></script>-->
<script type="text/javascript" src="<?php echo MOD_PATH;?>/js/mobile/iscroll.js" ></script>
<script type="text/javascript" src="<?php echo MOD_PATH;?>/js/mobile/navbarscroll.js" ></script>
<script type="text/javascript" src="./data/template/dzz_explorer_mobile_file_content_index_zh-cn.js" ></script><script type="text/javascript" src="<?php echo MOD_PATH;?>/js/mobile/index.js" ></script>
...
<script type="text/javascript" src="./data/template/dzz_explorer_mobile_file_content_jquery_fileupload-validate_zh-cn.js" ></script><script type="text/javascript" src="static/jquery_file_upload/jquery.fileupload-validate.js?<?php echo VERHASH;?>" ></script>
<script type="text/javascript">
    var folderjson='<?php echo $folderjson;?>',fid='<?php echo $fid;?>';
    $(function () {
